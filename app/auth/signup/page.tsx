  ...
  return (
    <div className='mx-auto max-w-sm my-14'>
      ...
      <form onSubmit={form.handleSubmit(onSubmit)}>
        ...
        />
        {form.formState.errors && <p className='text-red-500'>{form.formState.errors.username?.message}</p>}
        <InputFiled
          label="メールアドレス"
          name="email"
          type="email"
        ...
        <InputFiled
          ...
          register={form.register}
        />
        {form.formState.errors && <p className='text-red-500'>{form.formState.errors.password?.message}</p>}
        <div className='mt-4'>
          <Button
            type="submit"
